...
//Lets make an object to hold the draw properties of the image
...
function setup() {
  ...
  //lets calculate the aspect ratio of the image - this will never change so we only need to do it once
  imgDrwPrps.aspect = img.width / img.height;
  
  //now lets calculate the draw properties of the image using the function we made
...
class ImageSegment {
  ...
  calculateSegDrawProps() {
    ...
    //           Y0ffset Y0ffset Y0ffset Y0ffset Y0ffset
    //            ↓       ↓       ↓       ↓       ↓
    //  xOffset→ 0,0     0,1     0,2     0,3     0,4
    //  xOffset→ 1,0     1,1     1,2     1,3     1.4
    //  xOffset→ 2,0     2,1     2,2     2,3     2,4
    //  xOffset→ 3,0     3,1     3,2     3,3     3,4
    //  xOffset→ 4,0     4,1     4,2     4,3     4,4
  ...
  draw() {
    //lets draw the segment to the canvas, first we set the stroke and fill colours
    stroke(0);
