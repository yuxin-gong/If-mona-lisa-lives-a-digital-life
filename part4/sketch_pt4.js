...
class ImageSegment {
  ...
  draw() {
    ...
    rect(this.srcImgSegXPos, this.srcImgSegYPos, this.srcImgSegWidth*scale, this.srcImgSegHeight*scale);
  }
  update(){
    scale = map(dist(this.srcImgSegXPos, this.srcImgSegYPos,mouseX,mouseY),width,0,0,1);
    if (scale >1){
        scale =1;
    }
    if (scale<0){
